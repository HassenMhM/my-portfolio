export const data={
    ...
    js:{
        img:'/skills-icons/javascript.png',
        title:'JAVASCRIPT',
    ...
    es6:{
        img:'/skills-icons/ecmascript.png',
        title:'ECMASCRIPT 6',
    ...
    git:{
        img:'/skills-icons/git-github.png',
        title:'GIT/GITHUB',
